...
$plans = [
	[
		...
		'featured' => false,
		'features' => [
			__( 'Eine Kursstunde nach Wahl', 'body-and-mind' ),
			__( 'Persönliches Kennenlernen', 'body-and-mind' ),
		],
	...
	[
		...
		'featured' => true,
		'features' => [
			__( 'Alle Yoga- & Meditationskurse', 'body-and-mind' ),
			__( 'Personal-Training-Rabatt', 'body-and-mind' ),
			__( 'Monatlich kündbar', 'body-and-mind' ),
		],
	...
	[
		...
		'featured' => false,
		'features' => [
			__( '10 Kursstunden frei wählbar', 'body-and-mind' ),
			__( 'Übertragbar auf Freunde', 'body-and-mind' ),
		],
		'cta'      => __( 'Auswählen', 'body-and-mind' ),
	],
];
?>
<section id="preise" class="bm-section bm-section--cream">
	<div class="bm-container">
		...
		<div class="bm-section-head bm-section-head--center bm-reveal">
			...
			<h2 class="bm-section-title"><?php esc_html_e( 'Flexibel starten', 'body-and-mind' ); ?></h2>
			<p class="bm-section-head__text"><?php esc_html_e( 'Unverbindlich ausprobieren oder dauerhaft dabei sein — du entscheidest.', 'body-and-mind' ); ?></p>
		</div>
					...
					<ul class="bm-pricing-card__features">
						<?php foreach ( $plan['features'] as $feat ) : ?>
							<li class="bm-pricing-card__feature">
								<span class="bm-pricing-card__check">
									<?php echo bm_icon( 'check', 12 ); // phpcs:ignore ?>
								</span>
								<?php echo esc_html( $feat ); ?>
							</li>
						<?php endforeach; ?>
					</ul>
					<a href="<?php echo esc_url( home_url( '/kontakt/' ) ); ?>" class="bm-btn bm-btn--<?php echo $plan['featured'] ? 'primary' : 'secondary'; ?> bm-btn--full">
		...
		<div style="max-width:720px;margin:2rem auto 0" class="bm-reveal">
