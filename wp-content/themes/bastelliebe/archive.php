<?php
/**
 * Archive / category (Anleitungen) template.
 *
 * @package bastelliebe
 */
...
<main class="bl-page bl-section--cream">
	<div class="bl-container">
		<header class="bl-archive__header">
			<?php the_archive_title( '<h1 class="bl-archive__title">', '</h1>' ); ?>
		...
		<?php else : ?>
			<p><?php esc_html_e( 'Noch keine Anleitungen vorhanden. Schau bald wieder vorbei!', 'bastelliebe' ); ?></p>
		<?php endif; ?>
	</div>
</main>
<?php
